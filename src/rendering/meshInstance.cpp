...
MeshInstance::MeshInstance(const std::string& filePath, const unsigned int componentID) : componentID(componentID), filePath(filePath) {
...
void MeshInstance::generateMeshInstanceData() {
    MeshInstanceData data{Vector4(color.get(), opacity.get())};
